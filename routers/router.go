...
import (
	...
	"github.com/api-admin/controllers"
)
...
func init() {
	...
	beego.AutoRouter(&controllers.PythonApiController{})
	beego.AutoRouter(&controllers.GoApiController{})
	// beego.Include(&controllers.GoApiController{})
