...
-- ----------------------------
--  Table structure for `s_api_detail`
-- ----------------------------
DROP TABLE IF EXISTS `s_api_detail`;
CREATE TABLE `s_api_detail` (
...
-- ----------------------------
--  Records of `s_api_source`
-- ----------------------------
BEGIN;
INSERT INTO `s_api_source` VALUES ('1', '2', '会员基本信息', '2', '0', '1', '1', '1507616276', '1507616276', '0'), ('2', '2', '会员积分', '2', '0', '1', '1', '1507616329', '1507616329', '0'), ('3', '2', '会员消费', '2', '0', '1', '1', '1507616394', '1507616394', '0'), ('4', '1', '商品基本信息', '2', '0', '1', '1', '1507616421', '1507616421', '0');
COMMIT;

-- ----------------------------
--  Table structure for `s_set_code`
-- ----------------------------
DROP TABLE IF EXISTS `s_set_code`;
CREATE TABLE `s_set_code` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `s_set_code`
-- ----------------------------
BEGIN;
INSERT INTO `s_set_code` VALUES ('1', '200', '返回成功', '请求成功', '1', '0', '0', '1506328003', '1506328037'), ('2', '300', '返回错误', '请求失败', '1', '0', '0', '1506328023', '1506328023'), ('3', '302', '请求成功', '错误', '0', '0', '0', '1506328070', '1506334951');
COMMIT;

-- ----------------------------
--  Table structure for `s_set_env`
-- ----------------------------
DROP TABLE IF EXISTS `s_set_env`;
CREATE TABLE `s_set_env` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `s_set_env`
-- ----------------------------
BEGIN;
INSERT INTO `s_set_env` VALUES ('1', '测试地址', 'http://127.0.0.1:8081', '测试地址', '1', '0', '0', '1506316614', '1506316614'), ('2', '测试地址3', 'http://127.0.0.1:8083', '测试地址3', '0', '0', '0', '1506316696', '1506316850');
COMMIT;

-- ----------------------------
--  Table structure for `s_set_group`
-- ----------------------------
DROP TABLE IF EXISTS `s_set_group`;
CREATE TABLE `s_set_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `s_set_group`
-- ----------------------------
BEGIN;
INSERT INTO `s_set_group` VALUES ('1', '商品接口', '这是商品的分组', '1', '0', '1', '1506237536', '1507616254'), ('2', '会员接口', '关于会员的接口', '1', '0', '1', '1506237621', '1507616227'), ('3', '修改分组', '测试分组333', '0', '0', '0', '1506237655', '1506245311');
COMMIT;

-- ----------------------------
--  Table structure for `s_uc_admin`
-- ----------------------------
DROP TABLE IF EXISTS `s_uc_admin`;
CREATE TABLE `s_uc_admin` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `s_uc_admin`
-- ----------------------------
BEGIN;
INSERT INTO `s_uc_admin` VALUES ('1', 'admin', '超级管理员', '2f54a1e400e6a939e5f999b5b1a4d3bc', '0', '13888888889', 'haodaquan2008@163.com', 'Ctu3', '1507707108', '[', '1', '0', '0', '0', '1506128438'), ('2', 'george518', 'georgeHao', 'e5d77ebaffd5e4fe7164b31c6d7f1921', '1,2', '13811558899', '12@11.com', 'ONNy', '1506125048', '127.0.0.1', '1', '0', '0', '0', '1506128425'), ('3', 'haodaquan', '郝大全', 'e9fa9187e7497892c237433aee966cc1', '2,1', '13811559988', 'hao@123.com', '6fWE', '1505960085', '127.0.0.1', '1', '1', '0', '1505919245', '1506128414'), ('4', 'ceshizhanghao', '测试姓名', 'fa3fb5825c2e64bc764f29245dd1ec7a', '2', '13988009988', '232@124.com', 'i8Nf', '0', '', '1', '1', '0', '1506047337', '1506128397');
COMMIT;

-- ----------------------------
--  Table structure for `s_uc_auth`
-- ----------------------------
DROP TABLE IF EXISTS `s_uc_auth`;
CREATE TABLE `s_uc_auth` (
...
-- ----------------------------
--  Records of `s_uc_role`
-- ----------------------------
BEGIN;
INSERT INTO `s_uc_role` VALUES ('1', 'API管理员', '拥有API所有权限', '0', '2', '1', '1505874156', '1505874156'), ('2', '系统管理员', '系统管理员', '0', '0', '1', '1506124114', '1506124114');
COMMIT;

-- ----------------------------
--  Table structure for `s_uc_role_auth`
-- ----------------------------
DROP TABLE IF EXISTS `s_uc_role_auth`;
CREATE TABLE `s_uc_role_auth` (
...
-- ----------------------------
--  Records of `s_uc_role_auth`
-- ----------------------------
BEGIN;
INSERT INTO `s_uc_role_auth` VALUES ('1', '16'), ('1', '17'), ('1', '18'), ('1', '19'), ('2', '0'), ('2', '1'), ('2', '15'), ('2', '20'), ('2', '21'), ('2', '22'), ('2', '23'), ('2', '24');
COMMIT;
